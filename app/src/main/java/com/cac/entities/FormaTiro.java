 ...
 */
public class FormaTiro extends Entity {

    public static final String TABLE_NAME  = "ba_forma_tiro";
    public static final String ID_EMPRESA  = "id_empresa";
    public static final String ID          = "forma_tiro";
